...
const String __DARWIN_SUF_64_BIT_INO_T = r'$INODE64';

const String __DARWIN_SUF_1050 = r'$1050';

const String __DARWIN_SUF_EXTSN = r'$DARWIN_EXTSN';
...
const String _PATH_PWD = '/etc';

const String _PATH_PASSWD = '/etc/passwd';

const String _PASSWD = 'passwd';

const String _PATH_MASTERPASSWD = '/etc/master.passwd';

const String _PATH_MASTERPASSWD_LOCK = '/etc/ptmp';

const String _MASTERPASSWD = 'master.passwd';

const String _PATH_MP_DB = '/etc/pwd.db';

const String _MP_DB = 'pwd.db';

const String _PATH_SMP_DB = '/etc/spwd.db';

const String _SMP_DB = 'spwd.db';

const String _PATH_PWD_MKDB = '/usr/sbin/pwd_mkdb';

const int _PW_KEYBYNAME = 49;

const int _PW_KEYBYNUM = 50;

const int _PW_KEYBYUID = 51;

const int _PASSWORD_EFMT1 = 95;

const int _PASSWORD_LEN = 128;

const int _PASSWORD_NOUID = 1;

const int _PASSWORD_NOGID = 2;

const int _PASSWORD_NOCHG = 4;

const int _PASSWORD_NOEXP = 8;

const int _PASSWORD_WARNDAYS = 14;

const int _PASSWORD_CHGNOW = -1;
